...
Ent instantiateDesertLvl2Room7(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateMummyLvl2(world, position + glm::vec2(-8, -8)),
        instantiateInsect(world, position + glm::vec2(-48, -32)),
        instantiateInsect(world, position + glm::vec2(32, 16)),
        ...
        // Traps:
        instantiateTNTBarel(world, position + glm::vec2(-64, 16)),
