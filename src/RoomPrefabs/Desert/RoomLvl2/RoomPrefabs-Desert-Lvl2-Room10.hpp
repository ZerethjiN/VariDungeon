...
Ent instantiateDesertLvl2Room10(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors
        instantiateSarcophageClose(world, position + glm::vec2(-8, -16)),
        instantiateSarcophageOpen(world, position + glm::vec2(-8, 0)),
        ...
        instantiateMummyLvl2(world, position + glm::vec2(-48, 16)),
    });
