...
Ent instantiateDesertLvl2Room1(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors
        instantiateColumnBanner(world, position + glm::vec2(-64, -40)),
        instantiateColumnBanner(world, position + glm::vec2(-64, 24)),
        instantiateColumnBanner(world, position + glm::vec2(48, -40)),
        instantiateColumnBanner(world, position + glm::vec2(48, 24)),

        // Enemies:
        instantiateSlimeLvl2(world, position + glm::vec2(-8, -8)),
        instantiateSlimeLvl2(world, position + glm::vec2(-48, 16)),
        instantiateSlimeLvl2(world, position + glm::vec2(32, -32)),
        instantiateScorpion(world, position + glm::vec2(-48, -32)),
        instantiateScorpion(world, position + glm::vec2(32, 16)),
    });
