...
Ent instantiateDesertLvl2Room12(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.append_children(chunkHolderEnt, {
        ...
        // Decors
        instantiateSarcophageOpen(world, position + glm::vec2(-56, -32)),
        instantiateSarcophageOpen(world, position + glm::vec2(40, 16)),
        instantiateSand(world, position + glm::vec2(-32, -32)),
        instantiateSand(world, position + glm::vec2(16, 16)),

        // Enemies:
        // instantiateInsect(world, position + glm::vec2(32, -32)),
        // instantiateInsect(world, position + glm::vec2(-48, -16)),
        instantiateInsect(world, position + glm::vec2(-8, -8)),
        instantiateSlimeLvl2(world, position + glm::vec2(-64, -48)),
