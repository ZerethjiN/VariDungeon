...
Ent instantiateDesertLvl2Room11(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors
        instantiateSarcophageClose(world, position + glm::vec2(-40, -48)),
        instantiateSarcophageClose(world, position + glm::vec2(-40, -32)),
        instantiateSarcophageClose(world, position + glm::vec2(24, 16)),
        instantiateSarcophageClose(world, position + glm::vec2(24, 32)),
        instantiateCandlestick(world, position + glm::vec2(-64, -40)),
        instantiateCandlestick(world, position + glm::vec2(48, 24)),

        // Enemies:
        instantiateRoboboule(world, position + glm::vec2(32, -32)),
        instantiateRoboboule(world, position + glm::vec2(-48, -16)),

        // Breakables:
        instantiateRock(world, position + glm::vec2(-64, 32)),
