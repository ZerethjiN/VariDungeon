...
Ent instantiateDesertLvl2Room5(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateGasterolcan(world, position + glm::vec2(-48, -32)),
        instantiateGasterolcan(world, position + glm::vec2(32, 16)),
        instantiateGasterolcan(world, position + glm::vec2(-48, 16)),
