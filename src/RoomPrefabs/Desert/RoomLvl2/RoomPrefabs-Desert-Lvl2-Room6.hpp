...
Ent instantiateDesertLvl2Room6(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        instantiateSlimeLvl2(world, position + glm::vec2(-48, -48)),
        ...
        // Traps:
        instantiateSpike(world, position + glm::vec2(-24, -8)),
        instantiateSpike(world, position + glm::vec2(8, -8)),
        instantiateSpike(world, position + glm::vec2(-8, -24)),
        instantiateSpike(world, position + glm::vec2(-8, 8)),
        instantiateSpike(world, position + glm::vec2(-40, -8)),
        instantiateSpike(world, position + glm::vec2(24, -8)),
    });
