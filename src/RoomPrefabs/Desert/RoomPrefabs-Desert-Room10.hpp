...
Ent instantiateDesertRoom10(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        ...
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5],
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors:
        instantiateObelisk(world, position + glm::vec2(-32, -8)),
        instantiateObelisk(world, position + glm::vec2(16, -8)),
        ...
        instantiateAnubis(world, position + glm::vec2(-64, 32)),
        instantiateAnubis(world, position + glm::vec2(48, -48)),
    });
