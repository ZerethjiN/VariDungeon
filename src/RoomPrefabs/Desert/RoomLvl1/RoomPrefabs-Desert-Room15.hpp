...
Ent instantiateDesertRoom15(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.append_children(chunkHolderEnt, {
        ...
        // Decors:
        instantiateSand(world, position + glm::vec2(16, -48)),
        instantiateSand(world, position + glm::vec2(-32, 32)),
        instantiateSand(world, position + glm::vec2(48, 16)),
        instantiateSand(world, position + glm::vec2(-64, -32)),
        instantiatePylon(world, position + glm::vec2(-8, -8)),

        // Enemies:
        instantiateMummy(world, position + glm::vec2(-24, -8)),
        instantiateMummy(world, position + glm::vec2(8, -8)),
    });
