...
Ent instantiateDesertRoom5(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5],
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors:
        instantiateSphere(world, position + glm::vec2(-56, -48)),
        instantiateSphere(world, position + glm::vec2(40, -48)),
        instantiatePylon(world, position + glm::vec2(-64, 24)),
        instantiatePylon(world, position + glm::vec2(48, 24)),

        // Enemies:
        instantiateRoboboule(world, position + glm::vec2(0, -8)),
        instantiateRoboboule(world, position + glm::vec2(-16, -8)),

        // Traps:
        instantiateSpike(world, position + glm::vec2(-32, -48)),
        instantiateSpike(world, position + glm::vec2(16, -48)),
        instantiateSpike(world, position + glm::vec2(-48, 32)),
        instantiateSpike(world, position + glm::vec2(32, 32)),
    });
