...
Ent instantiateDesertRoom19(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5],
        tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateSlime(world, position + glm::vec2(-24, -8)),
        instantiateSlime(world, position + glm::vec2(8, -8)),
        instantiateSlime(world, position + glm::vec2(-8, -24)),
        instantiateSlime(world, position + glm::vec2(-8, 8)),

        // Traps:
        instantiateTNTBarel(world, position + glm::vec2(-8, -8)),
        instantiateTNTBarel(world, position + glm::vec2(-48, -48)),
        instantiateTNTBarel(world, position + glm::vec2(-64, -32)),
        ...
        instantiateJar(world, position + glm::vec2(48, 16)),
    });
