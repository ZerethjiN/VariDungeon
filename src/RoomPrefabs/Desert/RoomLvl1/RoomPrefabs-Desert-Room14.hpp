...
Ent instantiateDesertRoom14(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors:
        instantiateCrystal(world, position + glm::vec2(-64, -48)),
        instantiateCrystal(world, position + glm::vec2(-48, -48)),
        instantiateCrystal(world, position + glm::vec2(-64, -32)),
