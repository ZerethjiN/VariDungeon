...
Ent instantiateDesertRoom7(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateAnubis(world, position + glm::vec2(-64, -48)),
        instantiateAnubis(world, position + glm::vec2(48, 32)),
        instantiateSlime(world, position + glm::vec2(-16, 0)),
        instantiateSlime(world, position + glm::vec2(0, 0)),

        // Breakables:
        instantiateWoodenBox(world, position + glm::vec2(-64, 32)),
