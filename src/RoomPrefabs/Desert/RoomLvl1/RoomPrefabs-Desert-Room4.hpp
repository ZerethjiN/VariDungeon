...
Ent instantiateDesertRoom4(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 11],
        tileMapDesertUV[ 13], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 11],
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[ 11],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateGasterolcan(world, position + glm::vec2(-16, -16)),
        instantiateGasterolcan(world, position + glm::vec2(0, 0)),
        instantiateSlime(world, position + glm::vec2(-16, 0)),
        instantiateSlime(world, position + glm::vec2(0, -16)),
        ...
        instantiateTorch(world, position + glm::vec2(32, -48)),
