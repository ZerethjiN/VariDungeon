...
Ent instantiateDesertRoom9(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[  5], tileMapDesertUV[  3], tileMapDesertUV[  2], tileMapDesertUV[  3], tileMapDesertUV[ 30], tileMapDesertUV[  2], tileMapDesertUV[  3], tileMapDesertUV[  2], tileMapDesertUV[  3], tileMapDesertUV[  3],
        tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[  2], tileMapDesertUV[  3], tileMapDesertUV[ 30], tileMapDesertUV[ 30], tileMapDesertUV[  3], tileMapDesertUV[ 30], tileMapDesertUV[  3], tileMapDesertUV[  3],
        tileMapDesertUV[ 13], tileMapDesertUV[  5], tileMapDesertUV[  6], tileMapDesertUV[ 30], tileMapDesertUV[  3], tileMapDesertUV[  3], tileMapDesertUV[ 30], tileMapDesertUV[  3], tileMapDesertUV[  2], tileMapDesertUV[ 11],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateScorpion(world, position + glm::vec2(-8, -8)),
        instantiateInsect(world, position + glm::vec2(-48, 16)),
        instantiateInsect(world, position + glm::vec2(32, -32)),

        // Traps:
        instantiateVoidSphere(world, position + glm::vec2(-64, 32)),
        instantiateSpike(world, position + glm::vec2(-64, 16)),
