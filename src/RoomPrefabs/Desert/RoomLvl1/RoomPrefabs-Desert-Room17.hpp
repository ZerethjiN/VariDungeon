...
Ent instantiateDesertRoom17(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.append_children(chunkHolderEnt, {
        ...
        // Decors:
        instantiateSarcophageClose(world, position + glm::vec2(-40, -32)),
        instantiateSarcophageOpen(world, position + glm::vec2(-8, -32)),
        instantiateCandlestick(world, position + glm::vec2(32, -24)),
        instantiateCandlestick(world, position + glm::vec2(-32, 8)),
        instantiateSarcophageOpen(world, position + glm::vec2(-8, 16)),
        instantiateSarcophageOpen(world, position + glm::vec2(24, 16)),

        // Enemies:
        instantiateBat(world, position + glm::vec2(-8, -8)),
        instantiateAnubis(world, position + glm::vec2(-64, 32)),
        instantiateMummy(world, position + glm::vec2(48, -48)),
