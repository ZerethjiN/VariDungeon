...
Ent instantiateDesertRoom13(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Enemies:
        instantiateMiniRockSpawner(world, position + glm::vec2(-64, -48)),
