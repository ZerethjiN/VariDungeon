...
Ent instantiateHubKingsRoom(World& world, const glm::vec2& position, std::size_t width, std::size_t height, std::size_t chunkIdx, bool isDoorOpenUp, bool isDoorOpenDown, bool isDoorOpenLeft, bool isDoorOpenRight) {
    ...
    std::vector<TileMapTileInfo> backgroundTiles {
        ...
        tileMapDesertUV[ 13], tileMapDesertUV[ 30], tileMapDesertUV[  5], tileMapDesertUV[  5], tileMapDesertUV[  4], tileMapDesertUV[  1], tileMapDesertUV[  6], tileMapDesertUV[  5], tileMapDesertUV[ 30], tileMapDesertUV[ 11],
        ...
        tileMapDesertUV[ 30], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[  9], tileMapDesertUV[ 30],
    ...
    world.appendChildren(chunkHolderEnt, {
        ...
        // Decors:
        instantiateColumnBanner(world, position + glm::vec2(48, 8)),
        instantiateColumnBanner(world, position + glm::vec2(-64, 8)),
        instantiateColumnBanner(world, position + glm::vec2(32, -40)),
        instantiateColumnBanner(world, position + glm::vec2(-48, -40)),

        instantiateKing(world, position + glm::vec2(-8, -40)),

        instantiateShadowBossHub(world, position),

        instantiateTorchDecor(world, position + glm::vec2(-64, -48)),
        instantiateTorchDecor(world, position + glm::vec2( 48, -48)),
        instantiateTorchDecor(world, position + glm::vec2(-64,  32)),
        instantiateTorchDecor(world, position + glm::vec2( 48,  32)),
